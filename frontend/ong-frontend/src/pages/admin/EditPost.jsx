...
const EditPost = () => {
  ...
  const handleSubmit = async (publish = false) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.error || 'Erro ao atualizar post. Tente novamente.';
      alert(errorMessage);
    } finally {
      setLoading(false);
    }
              ...
              <CardContent className="space-y-4">
                <div className="space-y-4">
                    ...
                    {imagePreview ? (
                      <div className="space-y-4">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            setImagePreview(formData.currentImage);
                            setFormData(prev => ({ ...prev, featuredImage: null }));
                          }}
                        >
                          {formData.currentImage ? 'Restaurar Imagem Original' : 'Remover Imagem'}
                        </Button>
                      </div>
                    ) : (
                      <div className="space-y-2">
                  ...
                  >
                    ...
                    {formData.featuredImage ? 'Alterar Imagem' : 'Selecionar Nova Imagem'}
                  </Button>
                </div>
              </CardContent>
            </Card>
